...
| **5. Erst danach ausbauen** | Mobile App mit Offline-Sync · KI · Schnittstellen (DATEV, GAEB, DATANORM). **Stand:** DATEV-Export der Ausgangsrechnungen (Buchungsstapel EXTF), Zahlungseingänge und offene Posten, freie Angebotspositionen und Bearbeiten von Entwürfen umgesetzt; Mahnwesen (Zahlungserinnerung, 1. und 2. Mahnung, optional mit Gebühren, Verzugszinsen und Pauschale); Bankabgleich (Kontoauszug CAMT.053 einlesen, Zahlungen zuordnen); Dokumente am Projekt mit Texterkennung und Suche; Finanzbereich (Kontostände, Kontobewegungen, Forderungen, Monatsübersicht, Ausgabenkategorien mit Regeln und Lernen, Fixkosten, Jahresüberblick, Eingangsrechnungen mit E-Rechnung und Abgleich, Liquiditätsvorschau) mit Rolle Buchhaltung; Lagepläne am Projekt (Zeichnen mit Maßstab, Mengen); offen sind Mobile App, GAEB und DATANORM |
