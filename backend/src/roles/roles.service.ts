...
export class RolesService {
  ...
  async setPermissions(companyId: string, roleId: string, keys: string[]) {
  ...
  async assignToUser(companyId: string, roleId: string, userId: string) {
    await this.assertRoleBelongsToCompany(companyId, roleId);
  ...
  async removeFromUser(companyId: string, roleId: string, userId: string) {
    await this.assertRoleBelongsToCompany(companyId, roleId);
